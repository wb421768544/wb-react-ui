...
export default function NotificationCenter(options = {}) {
  ...
  Array.prototype.forEach.call(
    document.querySelectorAll('.wb-notication-container'),
    (container, index) => {
      if(index === 0) {
  ...
  // 添加动画
  newNotificate.classList.add('wb-notication-container');
...
function updateView(container, onClose) {
  const containerList = [...document.querySelectorAll('.wb-notication-container')];
  onClose && onClose();
